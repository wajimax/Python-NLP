...
if __name__ == "__main__":
	...
	#割当TOPICの書き込みパス
	doc_topic_allot_path = conf.simulation_conf.lsi_gensim_topic_allot
	
	#割当最大TOPICの書き込みパス
	doc_max_allot_path = conf.simulation_conf.lsi_gensim_topic_max_allot
	
	#TOPICの割当
	allot_topic_list = topic.lsi_topic_allot(file_path,dic_path,corpa_path,topic_path)
